...
public class AboutPopupWindow extends PopupWindow {
    ...
    private static class AboutPane extends JEditorPane {
        ...
        private static final String TEXT = "<p>This race simulation program has been produced by Michael Ruocco, " +
                "it is a rework of a solution to a computer programming project set as part of the CS223 - " +
